...
class PileUpCorrection{
  ...
  const char*         _stMCFileName{};
  const char*         _stDataFileName{};
  ...
  void SetMCFileName(const char*  name){_stMCFileName=name;}
  void SetDataFileName(const char*  name){_stDataFileName=name;}
